...
EX4_EMPLOYEES = [(1, "Alice", "Engineer"), (2, "Bob", "Manager"), (3, "Carol", "Analyst")]

EX4_PARAMS = [
    pytest.param(
        [(1, 38.0, 50.0),   # no overtime: 38*50 = 1900
         (2, 45.0, 60.0),   # overtime:    40*60 + 5*60*1.5 = 2850
         (3, 40.0, 40.0)],  # exactly 40:  40*40 = 1600
...
COUNTRIES_DATA = [("IND", "India"), ("AUS", "Australia"), ("WI", "WestIndies"), ("SA", "SouthAfrica")]
...
EX15_PARAMS = [
    pytest.param(
        [(1, 101, "2025-05-10", 1, 25.0),
         ...
         (1, 106, "2025-05-10", 1, 10.0)],  # 6 products → 106 excluded
...
EX16_PARAMS = [
    pytest.param(
        [(1, 2022, 100.0), (1, 2023, 200.0),
         (2, 2022, 300.0), (2, 2023, 200.0),
         (3, 2022, 100.0), (3, 2023, 100.0)],
        {1},
        id="standard",
    ),
    pytest.param(
    ...
    pytest.param(
        [(1, 2022, 100.0), (1, 2023, 200.0),
         (2, 2022, 100.0), (2, 2023, 200.0),
         (3, 2022, 100.0), (3, 2023, 200.0)],
        {1, 2, 3},
        id="all_increasing",
    ),
    pytest.param(
        [(1, 2022, 500.0), (1, 2023, 100.0),
         (2, 2022, 500.0), (2, 2023, 100.0),
         (3, 2022, 500.0), (3, 2023, 100.0)],
        set(),
        id="all_decreasing",
    ),
]
...
EX17_PARAMS = [
    pytest.param(
        [(1, 10.0, 4.0), (2, 10.0, 4.0), (3, 11.0, 4.0), (4, 11.0, 4.0),
         (5, 12.0, 4.0), (6, 12.0, 4.0), (7, 13.0, 4.0), (8, 13.0, 4.0),
         (9, 100.0, 4.0)],
        {1, 2, 3, 4, 5, 6, 7, 8},
